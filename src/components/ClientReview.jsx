...
const testimonials = [
  {
    name: "Ravi Kumar",
    role: "SEO Specialist",
    avatar: "/image/testimonial/testi-1.jpg",
  ...
  },
  {
    ...
    avatar: "/image/testimonial/testi-2.jpg",
  ...
  },
  {
    name: "Vijay Singh",
    role: "PPC Manager",
    avatar: "/image/testimonial/testi-3.jpg",
  ...
  },
  {
    ...
    avatar: "/image/testimonial/testi-4.jpg",
  ...
  },
  {
    ...
    avatar: "/image/testimonial/testi-5.jpg",
  ...
  },
  {
    ...
    avatar: "/image/testimonial/testi-6.jpg",
...
const ClientReview = () => {
  return (
    <section className="pb-12 mx-auto md:pb-20 max-w-7xl">
      ...
      <div className="gap-8 space-y-8 md:columns-2 lg:columns-3 px-5">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="p-8 bg-gray-900 border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            <div className="flex gap-4 items-start">
              ...
              <div className="flex-1 flex justify-between items-start">
                <div>
                  <h6 className="text-lg font-medium text-gray-400">{testimonial.name}</h6>
